...
export declare const Stage: import("@sinclair/typebox").TObject<{
    ...
    timeStep: import("@sinclair/typebox").TArray<import("@sinclair/typebox").TTuple<[import("@sinclair/typebox").TDate, import("@sinclair/typebox").TDate]>>;
    detail: import("@sinclair/typebox").TArray<import("@sinclair/typebox").TString>;
}>;

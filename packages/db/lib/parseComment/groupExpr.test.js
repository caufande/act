...
test('表达式解析', t => {
    t.deepEqual(getGroupExpr('rr &ss&tt&uu & vv'), [
        Operation.And, 'vv', [
            Operation.And, 'uu', [
                Operation.And, 'tt', [
                    Operation.And, 'ss', 'rr',
    ...
    t.deepEqual(getGroupExpr('ww |xx|yy|zz | aaa'), [
        Operation.Or, 'aaa', [
            Operation.Or, 'zz', [
                Operation.Or, 'yy', [
                    Operation.Or, 'xx', 'ww',
    ...
    t.deepEqual(getGroupExpr('!!  !bbb'), [Operation.Not, [Operation.Not, [Operation.Not, 'bbb']]], '连与');
    t.deepEqual(getGroupExpr(['ccc ', '( !ddd & eee) ', '(!fff&ggg&!!hhh)']), demoGroupExpr, '扁平嵌套');
    t.throws(() => {
        getGroupExpr('asd&');
    }, '错误表达式');
    t.throws(() => {

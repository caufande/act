...
export type StartRuleNames = "Act";
export interface ParseOptions<T extends StartRuleNames = "Act"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Act">>(
  input: string,
  options?: Options,
): import('./Act').ActParsed;

...
for (let i = 0; i < taskQueen.length; i++) {
  ...
  await new Promise<void>((resolve) => setTimeout(resolve, 16))
    ...
    generatePageHandleAppear(page) {
        ...
        return `${this.buildConfig.isBuildNativeComp ? '' : `if (${((_a = this.appConfig.window) === null || _a === void 0 ? void 0 : _a.navigationStyle) === 'custom'
...
.padding({
  bottom: px2vp(sysInfo.screenHeight - (sysInfo.safeArea?.bottom || 0)),
    ...
    generatePageAboutToAppear(page) {
        ...
        let appearStr = `${isBlended ? 'initHarmonyElement()\n' : ''}${this.transArr2Str([].concat(this.buildConfig.isBuildNativeComp ? [] : [
...
this.removeTabBarEvent()` : 'callFn(this.page?.onUnload, this)'
    ...
    parse(rawId, page, name = 'TaroPage', resolve) {
        ...
        const pageRefresh = page instanceof Array
            ? page.map(e => { var _a; return this.isEnable((_a = this.appConfig.window) === null || _a === void 0 ? void 0 : _a.enablePullDownRefresh, e.config.enablePullDownRefresh); })
        ...
        if (this.isTabbarPage) {
            importList.push(...this.tabbarList.map((e, i) => `import page${i}, { config as config${i} } from './${e.pagePath}${entry_1.TARO_COMP_SUFFIX}'`));
        }
        else {
            importList.push(`import createComponent, { config } from "${node_path_1.default.resolve(targetRoot, page.originName) + entry_1.TARO_COMP_SUFFIX}"`);
        }

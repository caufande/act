        ...
        config: () => __awaiter(this, void 0, void 0, function* () {
            ...
            const output = {
                entryFileNames(chunkInfo) {
                    ...
                    const isTaroComp = appId === name || viteCompilerContext.pages.some(page => page.name === name) || ((_a = viteCompilerContext.components) === null || _a === void 0 ? void 0 : _a.some(comp => comp.name === name));

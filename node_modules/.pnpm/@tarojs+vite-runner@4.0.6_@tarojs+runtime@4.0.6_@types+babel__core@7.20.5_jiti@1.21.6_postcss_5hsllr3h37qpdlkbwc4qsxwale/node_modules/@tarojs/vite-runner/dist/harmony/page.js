                ...
                if (isTabbarPage) {
                    ...
                    list.forEach(pageName => {
                        ...
                        this.emitFile({
                            ...
                            code: parse.parse(node_path_1.default.resolve(appRoot, pageName), Object.assign(Object.assign({}, page), { originName: page.name, name: pageName, id }), name, this.resolve),
                            exports: ['default'],
                        });
                    });
                }

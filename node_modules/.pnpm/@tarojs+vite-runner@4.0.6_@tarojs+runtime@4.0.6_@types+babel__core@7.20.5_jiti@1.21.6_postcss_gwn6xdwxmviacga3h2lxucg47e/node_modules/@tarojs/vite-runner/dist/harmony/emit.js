            ...
            generateBundle(_outputOpts, bundle) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (taroConfig.isBuildNativeComp && typeof (pkg === null || pkg === void 0 ? void 0 : pkg.main) === 'string' && pkg.main) {
                        ...
                        comps.forEach(comp => {
                            var _a, _b;
                            const key = Object.keys(((_a = taroConfig.router) === null || _a === void 0 ? void 0 : _a.customRoutes) || {}).find(e => [comp.name, (0, utils_1.addLeadingSlash)(comp.name)].includes(e));
                            if (key) {
                                const alias = (_b = taroConfig.router) === null || _b === void 0 ? void 0 : _b.customRoutes[key];
                                if (alias instanceof Array) {
                                    alias.forEach(item => lines.push(`export * from './${node_path_1.default.join('src/main', 'ets', item)}'`));
                                }
                                else if (typeof alias === 'string') {
                                    lines.push(`export * from './${node_path_1.default.join('src/main', 'ets', alias)}'`);
                                }
                            }
                            else {
                                lines.push(`export * from './${node_path_1.default.join('src/main', 'ets', comp.name)}'`);
                            }
                        });
                        lines.push('');

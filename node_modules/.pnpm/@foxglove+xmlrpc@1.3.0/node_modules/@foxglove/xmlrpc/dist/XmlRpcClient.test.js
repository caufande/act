...
describe("XmlRpcClient", () => {
    it("Can call a method on a live server", (done) => {
        const server = http_1.default
            ...
            const client = new XmlRpcClient_1.XmlRpcClient(`http://localhost:${port}`);
    ...
    it("Can make a multicall", (done) => {
        const server = http_1.default
            ...
            expect(res2).toBeInstanceOf(XmlRpcFault_1.XmlRpcFault);
...
//# sourceMappingURL=XmlRpcClient.test.js.map